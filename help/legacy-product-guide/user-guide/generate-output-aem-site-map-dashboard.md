...
| --- | --- |
| Output Type | The type of output you want to generate. To generate responsive AEM Sites output, choose the AEM Sites option. |
| Setting Name | Give a descriptive name for the AEM Sites settings you are creating. For example, you can specify *Internal customers output* or *end-users output*. |
