...
>[!NOTE]
>
> You can also refer to the **Swagger documentation** for the publicly available REST APIs at `https://<aem-author-url>/libs/fmdita/clientlibs/api-docs/index.html`. You can also access the swagger documentation link through AEM interface by navigating to  **Tools** > **Guides** > **API Swagger**. Currently, only APIs related to Assets, Baseline, and Reporting are available in the Swagger documentation.
