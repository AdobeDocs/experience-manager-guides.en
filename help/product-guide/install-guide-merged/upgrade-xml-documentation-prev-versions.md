---
title: Upgrade Adobe Experience Manager Guides Previous Versions
...
To view upgrade instructions for latest versions, refer to [Upgrade Adobe Experience Manager Guides for version 4.6.0 and above](./upgrade-xml-documentation.md). 
