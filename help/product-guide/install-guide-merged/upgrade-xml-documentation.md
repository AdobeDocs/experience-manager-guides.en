...
- If you are on a version prior to 4.6.0, refer to [Upgrade Adobe Experience Manager Guides for version 4.4.0 and earlier](/upgrade-aem-guides-on-prem-prev-versions.md) for detailed upgrade instructions. 
