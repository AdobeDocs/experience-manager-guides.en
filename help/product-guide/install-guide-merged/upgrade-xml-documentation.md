...
level: Experienced
---
# Upgrade Adobe Experience Manager Guides for version 4.6.0 and above {#id224MBE0M0XA}
...
- If you are on a version prior to 4.6.0, refer to [Upgrade Adobe Experience Manager Guides for version 4.6.0 and earlier](./upgrade-xml-documentation-prev-versions.md). 
