...
Experience Manager Guides has a [**custom sling rewriter**](../install-guide-merged-merged/conf-output-generation.md#custom-rewriter) module for handling the links generated in case of cross-maps (links between the topics of two different maps).
