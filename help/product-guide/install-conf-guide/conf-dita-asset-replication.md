...
1. Use the instructions given in [Configuration overrides](../install-guide-merged-merged/download-install-config-override.md) to create the configuration file.
