...
The following tabs provide instructions to configure Regx for valid file name characters based on your Experience Manager Guides setup: Cloud Service or On-Premise.
