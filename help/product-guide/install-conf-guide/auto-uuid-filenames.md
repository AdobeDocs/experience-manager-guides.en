...
The following tabs provide instructions to configure auto-filenames based on UUID based on your Experience Manager Guides setup: Cloud Service or On-Premise.
