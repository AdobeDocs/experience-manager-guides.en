...
This release note covers the new and enhanced features along with the issues fixed in February 2026 release of Product Training and Learning content. 
...
- **Enable or disable negative scoring**: While configuring quiz properties, you can control negative scoring using the Allow negative final score option. When enabled, learners receive a minimum final score of zero, even if negative marking is applied. . 
