...
- **New options in the Insert menu**: Introducing new options in the Insert menu of the Editor toolbar to enrich your learning content: 
    ...
    - **Math equation**: Insert MathML equations seamlessly for technical or scientific topics.
    - **Knowledge check**: Add quick, non-graded quizzes within the learning topics to validate learner understanding.
