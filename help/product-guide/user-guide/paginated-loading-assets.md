...
Experience Manager Guides uses a paginated API for loading files and folders. Instead of loading all content at once, folders load progressively in batches of 50 assets, with additional assets retrieved automatically as you scroll or by selecting **Load more** option. 
