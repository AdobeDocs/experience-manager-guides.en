...
1. Deselect the **Use legacy component mapping** option.
   ...
   You can also create the AEM Sites presets using the legacy component mapping. To create the AEM Sites presets based on legacy component mapping, select **Use legacy component mapping** option from the New output preset dialog box. Some options may differ for the presets that use legacy component mapping.
...
View [AEM Sites configuration](#aem-sites-configuration) to understand the various configuration settings available for AEM Sites output in detail .
...
The following options are available for the AEM Sites output in the Content tab:
