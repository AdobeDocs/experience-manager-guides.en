...
>[!NOTE]
>
> You can also choose to switch to the New Editor for an improved table editing experience. For more details on table authoring features available in the New Editor, view [Work with tables in the New Editor](./web-editor-other-features.md#work-with-tables-in-the-new-editor).
