...
- Native AEM Site presets 
- Legacy AEM Site presets

### Native AEM Site presets

The Native AEM Site presets use the core component mapping of AEM. 
You can either use the DITA-OT or the native method of Experience Manager Guides to convert the content into normalized content and then to HTML. Then, use the HTML to create the AEM Site pages.   The Native AEM Site presets use the core WCM components and help you create customized components for AEM Sites.
With the native AEM Site presets you can use the predefined templates to ensure consistency in content layout and structure or create custom templates. 
In the Native AEM Site presets the configurations have been organized under the **General**,  **Content**, **Topic list**, and **Cross map references** tabs:

### Legacy AEM Site presets

You can also create the AEM Sites presets that use the legacy component mapping. These presets generate the AEM site output using only the DITA-OT method.
In the Legacy AEM Sites presets the configurations have been organized in the **General**,  **Content**, and **Cross map references** tabs:
...
Use site path -checkbox selected
Site path – same as output path (aem sites)
Topic page template *
Home page template
