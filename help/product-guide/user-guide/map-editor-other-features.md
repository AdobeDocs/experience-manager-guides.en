...
The Run health check option in the context menu lets you run a content health check on the selected map to catch issues such as broken links, duplicate IDs, and Schematron validation failures before publishing.
