...
-   All participating users can respond to comments submitted by other users. On a comment, select **Reply** and press Enter to submit a response. The reply box is multi-line and expandable, which helps users provide detailed replies to comments.
