...
The Translations section lists all available language copies for the currently opened asset in the Editor. The information is presented in a tabular view, showing each language code along with the corresponding file title or file name (whichever is available).
