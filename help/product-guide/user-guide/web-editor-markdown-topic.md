...
| Content insertion options | Provides options to insert a **Numbered list** &nbsp;![](images/S_TextNumbered_18_N.svg), **Ordered list** &nbsp;![](images/S_TextBulleted_18_N.svg), **Table** &nbsp;![](images/Table_icon.svg), **Image**&nbsp;![](images/S_ImageAdd_18_N.svg), **Cross reference**, and **Symbol** &nbsp;![](images/S_SpecialCharacter_18_N.svg) into a document.| 
