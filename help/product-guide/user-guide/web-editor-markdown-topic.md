...
| Text formatting options | Provides access to various text formatting options including **Headings** &nbsp;![](images/S_DisplayHeading_18_N.svg), **Bold**, **Italic**, **Strikethrough**, **Code** &nbsp;![](images/S_Code_18_N.svg), and **Block quote** &nbsp;![](images/S_BlockQuoteMultipleLines_18_N.svg).|
| Content insertion options | Provides options to insert a **Numbered list**, **Ordered list**, **Table**, **Image**&nbsp;![](images/S_ImageAdd_18_N.svg), **Cross reference**, and **Symbol** &nbsp;![](images/S_SpecialCharacter_18_N.svg) into a document.| 
