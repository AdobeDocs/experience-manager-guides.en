...
-   **From the Editor**: Allows you to generate topic list, manage the metadata of all references, view the multimedia list and fix all the broken links for the current DITA map from the Editor. You can sort the topics or filter them based on your selection. You also have the feature to bulk update the metadata of the selected topics. The metadata report is paginated. You can simply scroll down and all the new set of records keeps loading from the metadata.
