...
Selecting **Duplicate IDs** displays an a warning message identifying the specific element(s) with duplicate IDs. You can select the element directly from the error message and update it with a unique ID. 
