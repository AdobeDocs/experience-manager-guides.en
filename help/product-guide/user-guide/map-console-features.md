---
title: Map console features in Adobe Experience Manager Guides 
description: Learn about the vairous features available in Map console that allow you to publish and manage maps in Adobe Experience Manager Guides.
feature: Publishing
role: User
---
