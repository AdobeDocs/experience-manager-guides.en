---
title: Generate PDF
description: Learn how to create a PDF preset from the map console and the map dashboard. Configure PDF output preset in AEM Guides.
...
1. In the **Generate PDF Using** field, select a method to generate PDF. The available options are; DITA-OT and Native PDF.   
...
>[!NOTE]
>
> To learn about the configuration options for Native PDF, view [Publish PDF output](../web-editor/native-pdf-web-editor.md).
