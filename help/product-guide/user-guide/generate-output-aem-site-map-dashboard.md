---
title: AEM Site
description: Create and configure AEM site preset in AEM Guides from the Map Dashboard. Use AEM site support to generate article-based output, publish linked topics , conref, and search a string within the content.
feature: Publishing
role: User
---
# AEM Site presets on the map dashboard {#id205BE3008SW}
