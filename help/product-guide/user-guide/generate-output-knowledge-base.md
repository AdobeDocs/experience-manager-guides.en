...
| --- | --- |
| Publish Profile | Use the dropdown to select from the ServiceNow connection profiles your administrator configures. To learn more about how your administrator can create a publish profile, view the **Workspace settings** (appearing as **Settings** for **On-Prem** prior to version 5.2) feature description in the [Left Panel](./web-editor-features.md#id2051EA0M0HS) section. |
...
| --- | --- |
| Publish Profile | Use the drop-down to select from the Salesforce connection profiles your administrator configures. To learn more about how your administrator can create a publish profile, view the **Workspace settings** (appearing as **Settings** for **On-Prem** prior to version 5.2) feature description in [Tab bar](./web-editor-tab-bar.md). |
