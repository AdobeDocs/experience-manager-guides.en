...
3.  In the **Assets** tab, select **Add** to add an asset to this task. 
    ...
    * For review tasks, you are first prompted to select Asset type (Map or Topics), and then the selected files are displayed as following:
        ...
        ![Adding maps to a review task](./images/attach-asset-topics.png)    
        
        *Adding topics to a review task* 

        ![Adding maps to a review task](./images/attach-asset-maps.png)    
...
1. Access the task either from the [Overview](#accessing-assigned-tasks-from-overview-section) section or [Assigned to you](#managing-tasks-assigned-to-you) tab. 
    ...
    ![Authoring tasks in the Assigned to you tab](./images/authoring-task-access.png)
    
    *Authoring task in the Assigned to you tab*

    ![Authoring tasks in the Your tasks widget](./images/authoring-task-access-your-tasks.png)
...
1. Access the task either from the [Overview](#accessing-assigned-tasks-from-overview-section) section or [Assigned to you](#managing-tasks-assigned-to-you) tab. 
    ...
    ![Review tasks in the Assigned to you tab](./images/review-task-access.png)
    
    *Review task in the Assigned to you tab*

    ![Review tasks in the Your tasks widget](./images/review-task-access-your-tasks.png)
...
![Review tasks in the Author mode](./images/review-task-author-mode.png)
...
1. Access the task either from the [Overview](#accessing-assigned-tasks-from-overview-section) section or [Assigned to you](#managing-tasks-assigned-to-you) tab. 
   ...
   ![Translation tasks in the Assigned to you tab](./images/translation-tasks-access.png)
    
    *Translation task in the Assigned to you tab*

   ![Translation tasks in the Your tasks widget](./images/translation-tasks-access-your-tasks.png)
...
1. Access the task either from the [Overview](#accessing-assigned-tasks-from-overview-section) section or [Assigned to you](#managing-tasks-assigned-to-you) tab. 
    ...
    ![Publishing tasks in the Assigned to you tab](./images/publishing-tasks-access.png)
    
    *Publishing task in the Assigned to you tab*

    ![Publishing tasks in the Your tasks widget](./images/publishing-tasks-access-your-tasks.png)
