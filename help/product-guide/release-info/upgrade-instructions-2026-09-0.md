---
title: Release Notes | Upgrade instructions and fixed issues in Adobe Experience Manager Guides, 2026.09.0 release
description: Learn about the compatibility matrix and how to upgrade to the 2026.09.0 release of Adobe Experience Manager Guides as a Cloud Service.
---
# Upgrade instructions for the 2026.09.0 release 

This article covers the upgrade instructions and the compatibility matrix for the 2026.09.0 release of Adobe Experience Manager Guides as a Cloud Service.
...
This section points the compatibility matrix for the software applications supported by the 2026.09.0 release of Experience Manager Guides as a Cloud Service. 
...
| --- | --- | --- | --- |
| 2026.09.0 | Not compatible | 2022 or higher | 26.1 |
