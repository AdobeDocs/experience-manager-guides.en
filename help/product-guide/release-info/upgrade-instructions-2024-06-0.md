...
This article covers the upgrade instructions and the compatibility matrix for the 2024.06.0 release of Adobe Experience Manager Guides as a Cloud Service.
...
This section lists the compatibility matrix for the software applications supported by the 2024.06.0 release of Experience Manager Guides as a Cloud Service. 

### FrameMaker and FrameMaker Publishing Server

| Experience Manager Guides as a Cloud Release| FMPS | FrameMaker |
| --- | --- | --- |
| 2024.06.0 | Not compatible | 2022 or higher |
| | | |
