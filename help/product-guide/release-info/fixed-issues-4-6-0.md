...
- Once a topic’s document state is updated to **Done**, the **Start a New Release** icon is only available on the **Preview** mode of the topic.
 - When selecting a DITA asset in the Asset UI, the option **Open in FrameMaker** appears under **Manage Publication**, even though it is disabled in the configuration settings.
