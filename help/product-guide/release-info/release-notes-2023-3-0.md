...
1. Update `<dox.version>` property in `/dox/dox.installer/pom.xml` file of your Cloud Services Git code to 2023.3.242.
1. Commit the changes and run the Cloud Services pipeline to upgrade to the March 2023 release of AEM Guides as a Cloud Service.
