---
title: Release Notes | Upgrade instructions and fixed issues in Adobe Experience Manager Guides, 2026.07.0 release
description: Learn about the compatibility matrix and how to upgrade to the 2026.07.0 release of Adobe Experience Manager Guides as a Cloud Service.
---
# Upgrade instructions for the 2026.07.0 release 
...
This section points the compatibility matrix for the software applications supported by the 2026.07.0 release of Experience Manager Guides as a Cloud Service. 

### FrameMaker and FrameMaker Publishing Server

| Experience Manager Guides as a Cloud Release| FMPS | FrameMaker | Oxygen Author |
| --- | --- | --- | --- |
| 2026.07.0 | Not compatible | 2022 or higher | 26.1 |
