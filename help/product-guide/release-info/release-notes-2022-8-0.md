...
1. Update `<dox.version>` property in `/dox/dox.installer/pom.xml` file of your Cloud Services Git code to 2022.8.167.
1. Commit the changes and run the Cloud Services pipeline to upgrade to the August release of AEM Guides as a Cloud Service.
