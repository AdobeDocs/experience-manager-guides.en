---
title: Release Notes | Upgrade instructions and fixed issues in Adobe Experience Manager Guides, 2025.07.0 release
description: Learn about the compatibility matrix and how to upgrade to the 2025.07.0 release of Adobe Experience Manager Guides as a Cloud Service.
exl-id: 391b8995-3938-4de6-b402-599a1c8df100
---
# Upgrade instructions for the 2025.07.0 release 

This article covers the upgrade instructions and the compatibility matrix for the 2025.07.0 release of Adobe Experience Manager Guides as a Cloud Service.
...
This section points the compatibility matrix for the software applications supported by the 2025.07.0 release of Experience Manager Guides as a Cloud Service. 

### FrameMaker and FrameMaker Publishing Server

| Experience Manager Guides as a Cloud Release| FMPS | FrameMaker |
| --- | --- | --- |
| 2025.07.0 | Not compatible | 2022 or higher |
