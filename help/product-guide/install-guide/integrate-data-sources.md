...
1. **Set up the data source connector**
   ...
   >[!NOTE]
   >
   > Access the Konnect definition module and implement the Connector interface to create a custom connector. Learn more about how to [configure custom data source connectors](../install-guide/conf-custom-data-source-connector.md).
