...
- If you are using version 4.2, 4.1, or 4.1.x then you need to upgrade to version 4.3.1.5, 4.3.1, 4.3.0, or 4.2.1 (Hotfix 4.2.1.3) before upgrading to version 4.4.0.
...
Upgrading to version 4.3.1.5 depends on the current version of Experience Manager Guides. If you are using version 4.3.1, 4.3.0, 4.2, or 4.2.1 then you can directly upgrade to version 4.3.1.5.
...
Before you start the Experience Manager Guides 4.3.1.5 upgrade process, ensure that you have:

1.  Upgraded to Experience Manager Guides version 4.3.1, 4.3.0, 4.2, or 4.2.1 (Hotfix 4.2.1.3) and completed their respective installation step.
1.  (Optional) Closed all translation tasks.
1. Changed the log level to **INFO** for `com.adobe.fmdita.translationservices.TranslationMapUpgradeScript` class and append these logs in a new log file, for example, `logs/translation_upgrade.log`.
...
1. You can choose to HIT the trigger to start the translation map upgrade job. For details, see [Enable trigger of script via a Servlet](#enable-trigger-serverlet-4-3-1-5).
...
### Enable trigger of script via a Servlet{#enable-trigger-serverlet-4-3-1-5}
...
>[!NOTE]
>
> You need not perform these steps if you upgrade from 4.3.1, 4.3.0, or 4.2.1 (Hotfix 4.2.1.3).
