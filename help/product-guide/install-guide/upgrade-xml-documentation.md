...
You can upgrade your current version of Experience Manager Guides to version 5.0.0:


- If you are using version 4.6.3, 4.6.1, 4.6, or 4.4 then you can directly upgrade to version 5.0.0.
- If you are using version 4.2, 4.2.1 (Hotfix 4.2.1.3), 4.1, or 4.1.x then you need to upgrade to version 4.4 before upgrading to version 5.0.0.
...
>[!TIP]
>
> It is recommended to install 4.6.0 Service Pack 3 on top of version 4.6.0 or 4.6.0 Service Pack 1. The upgrade process for the 4.6.0 Service Pack 3 release follows the same steps as the 4.6.0 release. 
...
>[!TIP]
>
> Upgrading to version 5.0.0 depends on the current version of Experience Manager Guides. If you are using version 4.6.3, 4.6.1, 4.6.0, or 4.4 then you can directly upgrade to version 5.0.0.
