...
You can upgrade your current version of Experience Manager Guides to version 5.1.0 Service Pack 4:
...
>[!TIP]
>
> Upgrading to version 5.0.0 Service Pack 4 depends on the current version of Experience Manager Guides. If you are using version 5.0.x, then you can directly upgrade to version 5.0.0 Service Pack 4.
...
>[!NOTE]
>
>If you are upgrading to 5.1.0 Service Pack 4, then you need to be on the version 5.1.0 or 5.1.x of Experience Manager Guides. 
