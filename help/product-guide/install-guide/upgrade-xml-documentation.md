...
You can upgrade your current version of Experience Manager Guides to version 4.6.0.1:
...
>[!TIP]
>
> It is recommended to install Hotfix 4.6.0.1 on top of version 4.6.0. The upgrade process for the 4.6.0.1 release follows the same steps as the 4.6.0 release. 
