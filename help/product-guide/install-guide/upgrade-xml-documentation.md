...
- If you are using version 4.6.3, 4.6.1, or 4.6, then you can directly upgrade to version 5.0.0.
- If you are using version 4.4, then you need to upgrade to version 4.6.0. 
