...
- {hide-from-toc} [AEM Guides Landing page](aemg-documentation-overview.md)
  ...
  - Release Notes {#release-notes}
    - Cloud Services {#cloud-release-notes}
      ...
      - 2026 Releases {#2026-releases}
        - 2026.09.0 Release {#2609-release}
...
- User Guide (New UI) {#user-guide}
  ...
  - Manage Learning Content {#learning-training-content}
    ...
    - Configuration guide {#config-lc}
      ...
      - [Configure CSP for SCORM Preview](./lc-config-guide/guides-scorm-preview-config.md)
...
- Knowledge Base {#knowledge-base}
  ...
  - Articles {#kb-articles}
    ...
    - Publishing {#publishing}      
      ...
      - [Configure Edge Delivery Services](./knowledge-base/publishing/configure-eds.md)
